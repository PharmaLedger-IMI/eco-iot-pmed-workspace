...
function getDeviceById(request, response) {
  console.log("Calling get Device by id");
    ...
    flow.getDsuResourceById(keySSI, dbName, "Device", request.params.id, (error, result) => {
      if (error) {
