let LOADER_GLOBALS = {
	...
	LABELS_DICTIONARY: {
		...
		APP_DESCRIPTION: "The \"backend\" application for the clinical wallet",
  ...
  <h1 class="display-6">Welcome to the patient backend app!</h1>
  <p class="lead">After completing the following wizard you will gain access to patient backend app.</p>
